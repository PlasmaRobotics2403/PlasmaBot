...
class Whisper(PlasmaCog):
    ...
    async def sendWhisper(self, interaction, settings, origin_user, target, message):
        ...
        targetWhisperEmbed.set_author(name=f'{origin_user.display_name} ({origin_user.name})', icon_url=origin_user.display_avatar.url)
        ...
        logWhisperEmbed.set_author(name=f'{origin_user.display_name} ({origin_user.name}) → {target.display_name} ({target.name})', icon_url=origin_user.display_avatar.url)
